      ...
      >
        ...
        <div className="absolute top-3 left-3 right-3 flex items-center justify-between z-10 pointer-events-none">
          ...
          <div className="flex items-center gap-1.5">
            ...
            {discountPercent > 0 && (
              <span className="px-2.5 py-1 rounded-full text-[11px] font-bold tracking-wide uppercase bg-[#F6D9C8] text-[#6B3527] border border-[#E8BFA8] shadow-xs">
                {discountPercent}% OFF
              </span>
            )}
          </div>
        ...
        <div className="pt-2 flex items-center justify-between gap-2">
          <div>
            <div className="flex items-baseline gap-1.5 flex-wrap">
              ...
              {discountPercent > 0 && (
                <span className="text-[11px] font-bold text-[#A04F38]">
                  ({discountPercent}% off)
                </span>
              )}
            </div>
          ...
          <button
            ...
            className="inline-flex items-center gap-1 px-4 py-2 rounded-full bg-[#DCE9D8] hover:bg-[#C9DDC4] text-[#294735] border border-[#BFD2BA] text-xs font-semibold transition-all duration-200 cursor-pointer shadow-2xs hover:shadow-sm shrink-0"
          >
