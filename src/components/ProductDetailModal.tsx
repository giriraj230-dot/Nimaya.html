            ...
            <div>
              <div className="flex flex-col-reverse sm:flex-row gap-3">
                ...
                <div className="relative flex-1 aspect-square rounded-3xl overflow-hidden border border-[#E0E7DC] bg-[#F7F5EF] min-h-[310px] sm:min-h-0">
                  ...
                  {discountPercent > 0 && <span className="absolute top-4 left-4 px-3 py-1 rounded-full text-[10px] font-bold bg-[#F6D9C8] text-[#6B3527] border border-[#E8BFA8]">{discountPercent}% OFF</span>}
